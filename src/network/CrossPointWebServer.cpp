...
#ifdef CP_DISABLE_SD_CARD_FONTS

void CrossPointWebServer::handleFontsPage() const { server->send(404, "text/plain", "Not available"); }
void CrossPointWebServer::handleFontList() const { server->send(404, "application/json", "{\"error\":\"disabled\"}"); }
void CrossPointWebServer::handleFontUploadData() {}
void CrossPointWebServer::handleFontUpload() { server->send(404, "application/json", "{\"error\":\"disabled\"}"); }
void CrossPointWebServer::handleFontDelete() { server->send(404, "application/json", "{\"error\":\"disabled\"}"); }
...
#endif  // CP_DISABLE_SD_CARD_FONTS
