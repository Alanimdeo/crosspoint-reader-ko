...
void EpubReaderMenuActivity::loop() {
  ...
  auto activateSelected = [this] {
    ...
    // Reader Options is launched as a sub-activity so the menu stays on the stack — Back from
    // options returns to this menu, and only when the user exits the menu itself does
    // EpubReaderActivity apply layout changes.
