...
void DictionaryDefinitionActivity::wrapText() {
  ...
  // No SD prewarm step: Korean .epdfont reader fonts stream glyph metrics on demand through
  // SdFont's own cache, so there is no separate advance table to fill here.
