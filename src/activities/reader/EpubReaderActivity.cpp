  ...
  if (!section) {
    ...
    if (!section->loadSectionFile(SETTINGS.getReaderFontId(), SETTINGS.getReaderLineCompression(),
      ...
      // Always show "Indexing..." text first
      {
        ...
        renderer.drawText(UI_12_FONT_ID, boxXNoBar + boxMargin, boxY + boxMargin, "인덱싱 중...");
      ...
      auto progressSetup = [this, boxXWithBar, boxWidthWithBar, boxHeightWithBar, barX, barY] {
        ...
        renderer.drawText(UI_12_FONT_ID, boxXWithBar + boxMargin, boxY + boxMargin, "인덱싱 중...");
      ...
      if (!section->createSectionFile(SETTINGS.getReaderFontId(), SETTINGS.getReaderLineCompression(),
                                      SETTINGS.extraParagraphSpacing, SETTINGS.paragraphAlignment,
                                      SETTINGS.characterWrap, viewportWidth, viewportHeight, progressSetup,
                                      progressCallback)) {
